...
export default function VisionSection() {
    ...
    return (
        <section id="vision" className="py-20 bg-white">
            {/* Section heading */}
            <div className="max-w-360 mx-auto px-6 lg:px-23">
                <div className="mb-14">
            ...
            >
                <div ref={trackRef} className="flex gap-4 md:gap-6 w-max px-6 lg:px-23">
                    {marqueeCards.map((card, i) => (
                        <div
                            key={i}
                        className={`rounded-3xl border shadow-sm flex flex-col w-67.5 md:w-95 shrink-0 transition-transform duration-300 ease-out hover:scale-[1.08] ${
                                card.featured
